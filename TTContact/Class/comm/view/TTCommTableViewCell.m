...
@interface TTCommTableViewCell()
@property(nonatomic, weak, readwrite) TTCommTableView *parentTableView;
@end

@implementation TTCommTableViewCell
...
- (void)setCellUIByPosition:(CommonTableViewCellPosition)position
{
    if (self.position != position) {
        ...
        if (IOS_VERSION < 7) {
            self.backgroundView = [TTCommonCellBackgroundViewHelper backgroundViewForTableViewCell:self withType:[TTCommonCellBackgroundViewHelper CommonTableViewCellPositionToBackgroundViewType:position selected:false]];
            self.selectedBackgroundView = [TTCommonCellBackgroundViewHelper backgroundViewForTableViewCell:self withType:[TTCommonCellBackgroundViewHelper CommonTableViewCellPositionToBackgroundViewType:position selected:true]];
        }
    }
